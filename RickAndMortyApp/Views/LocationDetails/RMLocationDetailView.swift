...
final class RMLocationDetailView: UIView {
    ...
    private func createCollectionView() -> UICollectionView {
        ...
        collectionView.register(RMEpisdeInfoCollectionViewCell.self,
                                forCellWithReuseIdentifier: RMEpisdeInfoCollectionViewCell.cellIdentifier)
        collectionView.register(RMCharacterCollectionViewCell.self,
                                forCellWithReuseIdentifier: RMCharacterCollectionViewCell.collectionIdentifier)
        ...
        switch sectionType {
            case .information(let viewModels):
                ...
                guard let cell = collectionView.dequeueReusableCell(
                    withReuseIdentifier: RMEpisdeInfoCollectionViewCell.cellIdentifier,
                    for: indexPath
                ) as? RMEpisdeInfoCollectionViewCell else {
                    fatalError()
                }
